...
int main() {
    ...
    insert_at_head(2);
    insert_at_tail(3);
    printf("Doubly linked list after insetion at head and tail in forward direction ");
    display_forward(); // expected output: 2 1 3

    printf("\nDoubly linked list after insetion at head and tail in backward direction ");
