...
//Roll NO.->2204009
//Disclaimer this code is properly executed on the online compiler and I can't find my error in this code as it
//displays the correct answer in the online compiler
#include<stdio.h>
#include<stdlib.h>
struct node
{
